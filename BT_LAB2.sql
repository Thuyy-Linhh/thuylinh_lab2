# Câu 1:  Hiện thị thông tin các bảng dữ liệu trên.
...
# Câu 2: Đưa ra thông tin masp, tensp, tenhang,soluong, mausac, giaban, donvitinh, mota của các sản phẩm sắp xếp theo chiều giảm d?n giá bán.
